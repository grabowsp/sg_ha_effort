...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_04/genic_MNP_count_list_04depth.rds'
...
### SET OUTPUTS ###
fig_out_dir <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_04/'

fig_prefix <- 'genic_MNP_04depth_'

title_prefix <- 'Genic MNPs with 4+ reads per allele'
...
# 1390   13728   21210   20857   26132   60673
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   27.32  140.18  197.87  214.38  237.55 3391.33
