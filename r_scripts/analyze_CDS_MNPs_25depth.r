...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_25/CDS_MNP_count_list_25depth.rds'
...
fig_prefix <- 'CDS_MNP_25depth_'

title_prefix <- 'CDS MNPs with 25+ reads per allele'
...
#   0.00   75.75  142.00  140.14  197.75 1749.00 
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.0000   0.7132   1.2859   1.5856   1.7235 237.4248
