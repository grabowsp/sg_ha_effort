...
### SET INPUTS ###
# Counts of genic MNPSs above depth threshold in each allele
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_15/genic_MNP_count_list_15depth.rds'
...
### SET OUTPUTS ###
fig_out_dir <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_15/'

fig_prefix <- 'genic_MNP_15depth_'

title_prefix <- 'Genic MNPs with 15+ reads per allele'
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.00   11.67   19.69   19.55   24.44  708.20
