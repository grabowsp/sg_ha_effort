...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_10/CDS_MNP_count_list_10depth.rds'
...
fig_prefix <- 'CDS_MNP_10depth_'

title_prefix <- 'CDS MNPs with 10+ reads per allele'
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.1275   13.1735   18.4936   19.4024   21.2990 1111.3762
