...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_03/genic_MNP_count_list_03depth.rds'
...
### SET OUTPUTS ###
fig_out_dir <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_03/'

fig_prefix <- 'genic_MNP_03depth_'

title_prefix <- 'Genic MNPs with 3+ reads per allele'
...
# 3254   20190   30938   30375   37912   88576
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  37.86  208.32  290.38  316.00  350.28 4778.81
