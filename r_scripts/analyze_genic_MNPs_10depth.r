...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_10/genic_MNP_count_list_10depth.rds'
...
### SET OUTPUTS ###
fig_out_dir <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_10/'

fig_prefix <- 'genic_MNP_10depth_'

title_prefix <- 'Genic MNPs with 10+ reads per allele'
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.4677   32.2140   49.8982   49.7130   59.9836 1242.7812
