...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_03/CDS_MNP_count_list_03depth.rds'
...
fig_prefix <- 'CDS_MNP_03depth_'

title_prefix <- 'CDS MNPs with 3+ reads per allele'
...
#   1132    5627    7300    7480    8270   22538  
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   12.38   59.69   68.11   87.82   76.51 2786.92
