...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_06/CDS_MNP_count_list_06depth.rds'
...
fig_prefix <- 'CDS_MNP_06depth_'

title_prefix <- 'CDS MNPs with 6+ reads per allele'
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  3.468   28.272   35.273   41.351   39.810 1768.537 
