...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_07/genic_MNP_count_list_07depth.rds'
...
fig_prefix <- 'genic_MNP_07depth_'

title_prefix <- 'Genic MNPs with 7+ reads per allele'
...
#  111    6144    9670    9334   12070   25630
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  4.719   60.316   89.619   93.988  106.574 1797.315
