...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_05/genic_MNP_count_list_05depth.rds'
...
fig_prefix <- 'genic_MNP_05depth_'

title_prefix <- 'Genic MNPs with 5+ reads per allele'
...
#  565    9956   15754   15381   19374   43393
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  21.01  102.36  145.22  156.78  174.18 2518.37
