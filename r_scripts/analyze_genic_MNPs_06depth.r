...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_06/genic_MNP_count_list_06depth.rds'
...
### SET OUTPUTS ###
fig_out_dir <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_06/'

fig_prefix <- 'genic_MNP_06depth_'

title_prefix <- 'Genic MNPs with 6+ reads per allele'
...
#    241    7640   12154   11828   15081   32604
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#   10.25   77.55  111.95  119.80  134.46 2065.28
