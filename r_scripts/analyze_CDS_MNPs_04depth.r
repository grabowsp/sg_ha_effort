...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_04/CDS_MNP_count_list_04depth.rds'
...
fig_prefix <- 'CDS_MNP_04depth_'

title_prefix <- 'CDS MNPs with 4+ reads per allele'
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  9.87   45.08   52.94   65.53   59.13 2328.23
