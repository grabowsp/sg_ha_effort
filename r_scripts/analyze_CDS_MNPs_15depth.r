...
mnp_rds <- '/global/cscratch1/sd/grabowsp/sg_ploidy/MNP_counts/pos_15/CDS_MNP_count_list_15depth.rds'
...
fig_prefix <- 'CDS_MNP_15depth_'

title_prefix <- 'CDS MNPs with 15+ reads per allele'
...
#  0.0   517.2   859.0   790.3  1103.0  4771.0 
...
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  0.000   4.918   7.817   8.234   9.522 647.658
