...
vcf_in_1 <- '/global/cscratch1/sd/grabowsp/sg_ploidy/polyploid_vcfs/CDS_vcfs/geo_samps/Chr01K.polyploid.CDS.geosamps.vcf_01'
vcf_1 <- read.table(vcf_in_1, header = F, stringsAsFactors = F, sep = '\t')
