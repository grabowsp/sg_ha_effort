...
for(i in seq(length(combo_r2))){
  wind_r2_df[, names(combo_r2)[i]] <- combo_r2[[i]]$per_high_ld
}
...
#  9.000  10.000  10.000   9.885  10.000  10.000

up_8_2_ord <- apply(r2_ord_mat, 1, function(x) which(x == 4))

summary(up_8_2_ord)
#   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#  7.000   9.000   9.000   9.113   9.000  10.000
