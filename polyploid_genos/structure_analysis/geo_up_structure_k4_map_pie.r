...
column_vec <- c('K4_1', 'K4_2', 'K4_3', 'K4_4')

# colors of groups
k_col_vec <- c()
k_col_vec['K4_1'] <- 'darkorchid2'
k_col_vec['K4_2'] <- 'blue2'
k_col_vec['K4_3'] <- 'steelblue2'
k_col_vec['K4_4'] <- 'turquoise4'

# labels of groups
k_lab_vec <- c()
k_lab_vec['K4_1'] <- 'Mainly 8X - Cosmo'
k_lab_vec['K4_2'] <- '4X Dakotas'
k_lab_vec['K4_3'] <- '4X Great Lakes'
k_lab_vec['K4_4'] <- '8X MidEast'
