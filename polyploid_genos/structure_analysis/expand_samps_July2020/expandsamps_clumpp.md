...
cat expandgeo_alldip_2*_q > expandgeo_alldip_combo_q_tmp
```
#### Format input file for CLUMPP
* in R
```
...
in_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo_q_tmp'
...
write.table(out_res, out_file, quote=F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo.clumpp.indfile`
#### Run CLUMPP program for K=2
```
cd /home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip 
...
DATA_PRE=expandgeo_alldip_combo.clumpp
INDFILE=$DATA_PRE'.indfile'
MISCFILE=$DATA_PRE'.miscfile'
...
CLUMPP paramfile -i $INDFILE -o $OUTFILE -j $MISCFILE -k $N_K -c $N_C -r $N_R
```
* `expandgeo_alldip_combo.clumpp_k2.out`
...
pre_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo.clumpp.indfile'
pre_info <- read.table(pre_file, header = F, stringsAsFactors = F)

res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo.clumpp_k2.out'
res_info_tmp <- read.table(res_file, header = F, stringsAsFactors = F)
...
write.table(out_info, out_file, quote = F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo_k2.clumpp.processed`
...
cat expandgeo_alldip_3*_q > expandgeo_alldip_combo_q_tmp
```
#### Format input file for CLUMPP
* in R
```
...
CLUMPP paramfile -i $INDFILE -o $OUTFILE -j $MISCFILE -k $N_K -c $N_C -r $N_R
```
* `expandgeo_alldip_combo.clumpp_k3.out`
#### Process output from CLUMPP for K=3
```
bash
source activate R_analysis
...
res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo.clumpp_k3.out'
res_info_tmp <- read.table(res_file, header = F, stringsAsFactors = F)
...
write.table(out_info, out_file, quote = F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/all_dip/expandgeo_alldip_combo_k3.clumpp.processed`
...
cat expandgeo_partNA_2*_q > expandgeo_partNA_combo_q_tmp
```
#### Format input file for CLUMPP
* in R
```
...
in_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo_q_tmp'
...
write.table(out_res, out_file, quote=F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo.clumpp.indfile`
#### Run CLUMPP program for K=2
```
cd /home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA
...
DATA_PRE=expandgeo_partNA_combo.clumpp
INDFILE=$DATA_PRE'.indfile'
MISCFILE=$DATA_PRE'.miscfile'
...
CLUMPP paramfile -i $INDFILE -o $OUTFILE -j $MISCFILE -k $N_K -c $N_C -r $N_R
```
* `expandgeo_partNA_combo.clumpp_k2.out`
...
pre_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo.clumpp.indfile'
pre_info <- read.table(pre_file, header = F, stringsAsFactors = F)

res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo.clumpp_k2.out'
res_info_tmp <- read.table(res_file, header = F, stringsAsFactors = F)
...
write.table(out_info, out_file, quote = F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo_k2.clumpp.processed`
...
cat expandgeo_partNA_3*_q > expandgeo_partNA_combo_q_tmp
```
#### Format input file for CLUMPP
* in R
```
...
CLUMPP paramfile -i $INDFILE -o $OUTFILE -j $MISCFILE -k $N_K -c $N_C -r $N_R
```
* `expandgeo_partNA_combo.clumpp_k3.out`
...
res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo.clumpp_k3.out'
res_info_tmp <- read.table(res_file, header = F, stringsAsFactors = F)
...
write.table(out_info, out_file, quote = F, sep = '\t', row.names = F,
  col.names = F)
```
* `/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/expand_geo/part_NA/expandgeo_partNA_combo_k3.clumpp.processed`

## `expand_geo` `pseudohap`
```
bash
