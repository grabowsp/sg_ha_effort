# Template for generating map with pie charts to visualize structure results
...
# * change to combined results file
res <- read.table(res_file, header = T, sep = '\t', stringsAsFactors = F)

### SET OUTPUTS ###
k_val = 4
# * change to the K that is getting tested
...
# * change to the sample set name for the title on the plot
...
# * this is the name of the columns with the results, may need to manually
#     set this if change from standard pipeline when making input file
