...
c_res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/low_geo/lowgeo_k2_combo.clumpp.processed'
...
# pop 1 = Texas (and Gulfcoast); 197 4X, 3 6X, 7 8X
# pop 2 = Eastcoast; 270 4X, 1 6X, 4 8X

pop_order <- c(1,2)

group_col_vec <- c()
group_col_vec['1'] <- 'red2'
group_col_vec['2'] <- 'yellow3'

group_lab_vec <- c()
group_lab_vec['1'] <- 'Texas'
group_lab_vec['2'] <- 'East Coast'
