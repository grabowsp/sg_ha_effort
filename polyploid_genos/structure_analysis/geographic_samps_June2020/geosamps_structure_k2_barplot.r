...
c_res_file <- '/home/t4c1/WORK/grabowsk/data/switchgrass/polyploid_genos/struc/geo_v2/geo_v2_k2_combo.clumpp.processed'
...
tot_width <- base_width * ncol(c_res)/width_factor
...
group_lab_vec <- c()
group_lab_vec['1'] <- 'Lowland'
group_lab_vec['2'] <- 'Upland'
