# Script for generating a distance matrix from a tetrasomic VCF using 
#   ploidy-appropriate genotype dosages: disomic dosages for 4X samples and 
#   tetrasomic dosages for 8X samples
#
# Distance matrices use dosage genotypes ranging from 0 (homozygous ALT) to
#   2 (homozygous REF)
# For disomic dosages for 4X samples:
#   RRRA = RRAA = RAAA = 1.0
# For tetrasomic dosages for 8X samples:
...
out_suffix <- '_ploidy_DistMat.rds'
